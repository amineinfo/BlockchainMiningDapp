 ...
 */
/**
 * This class represents a filter for sorting patterns in the pattern vizualizer
 * window. It stores the column that the filter is applied to, and also the
...
public abstract class AbstractFilter {
	...
	/**
	 * Abstract method to determine if an object should be kept according to the
	 * filter
	 * 
	...
	/**
	 * Get a string representation of this filter including the given value and
	 * column name
	 * 
	 * @return a string representation of the filter indicating the filter name,
	 *         given value and column name.
	 */
