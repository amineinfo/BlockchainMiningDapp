...
/**
 * This class represents an itemset from a sequence where the itemset is a list
 * of strings ordered by lexical order and does not contain an item twice, and
 * the support of the itemset is not stored.
 * 
...
public class Itemset {
	...
	/**
	 * The list of items in this itemset. The items are lexically ordered and an
	 * item can only appear once in an itemset.
	 */
	...
	/**
	 * This methods makes a copy of this itemset but without items having a support
	 * lower than minsup
	 * 
	 * @param mapSequenceID  a map indicating the support of each item. key: item
	 *                       value: support
