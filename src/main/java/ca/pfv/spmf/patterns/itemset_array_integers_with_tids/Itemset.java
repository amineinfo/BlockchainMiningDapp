...
/**
 * This class represents an itemset (a set of items) where the itemset is an
 * array of integers sorted by lexical order where no item can appear twice, and
 * the ids of transactions/sequences containing this itemset is represented as a
 * set of integers.
 * 
