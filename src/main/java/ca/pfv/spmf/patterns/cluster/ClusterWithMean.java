...
/**
 * This class represents a cluster found by a clustering algorithm such as
 * K-Means. A cluster is a list of vectors of doubles.
 * 
 * @see DoubleArray
...
public class ClusterWithMean extends Cluster {
	...
	/**
	 * This method is called by clustering algorithms to recompute the mean of the
	 * cluster.
	 */
	...
	/**
	 * Method to remove a vector from this cluster and update the internal sum of
