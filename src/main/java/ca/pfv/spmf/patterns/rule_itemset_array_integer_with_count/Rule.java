...
public class Rule {
	 ...
	 * @param coverage         the support of the antecedent as a number of
	 *                         transactions
	 * @param transactionCount the absolute support of the rule (integer - a number
	 *                         of transactions)
	 ...
	 * 
	 * @param databaseSize the number of transactions in the database where this
	 *                     rule was found.
	...
	/**
	 * Get the coverage of the rule (the support of the rule antecedent) as a number
	 * of transactions
	 * 
