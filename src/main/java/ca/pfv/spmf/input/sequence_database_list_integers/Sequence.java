...
/**
 * Implementation of a sequence as a list of itemsets, where an itemset is a
 * list of integers.
 *
...
public class Sequence {
	...
	/**
	 * Make a copy of this sequence while removing some items that are infrequent
	 * with respect to a threshold minsup.
	 * 
	 * @param mapSequenceID  a map with key = item value = a set of sequence ids
	 *                       containing this item
	 * @param relativeMinSup the minimum support threshold chosen by the user.
	 * @return a copy of this sequence except that item(s) with a support lower than
	 *         minsup have been excluded.
	 */
	 ...
	 * with respect to a threshold minsup.
	 * 
	 * @param mapSequenceID  a map with key = item value = a set of sequence
	 *                       containing this item
	 * @param relativeMinSup the minimum support threshold chosen by the user.
	 * @return a copy of this sequence except that item(s) with a support lower than
	 *         minsup have been excluded.
	...
	/**
	 * Make a copy of an itemset while removing some items that are infrequent with
	 * respect to a threshold minsup.
	 * 
	 * @param mapSequenceID  a map with key = item value = a set of sequence
	 *                       containing this item
	 * @param relativeMinsup the minimum support threshold chosen by the user.
	 * @param itemset        the itemset
	 * @return a copy of this itemset except that item(s) with a support lower than
	 *         minsup have been excluded.
	 */
	public List<Integer> cloneItemsetMinusItems(double relativeMinsup, List<Integer> itemset,
			Map<Integer, Set<Sequence>> mapSequenceID) {
	 ...
	 *         minsup have been excluded.
	 */
	public List<Integer> cloneItemsetMinusItems(List<Integer> itemset, Map<Integer, Set<Integer>> mapSequenceID,
		...
		for (Integer item : itemset) {
			...
			// if this set is not null (an infrequent item) and the support is higher than
			// minsup...
