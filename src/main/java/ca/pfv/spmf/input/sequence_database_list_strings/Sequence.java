...
public class Sequence {
	...
	/**
	 * A sequence is a list of itemsets, where an itemset is a list of strings
	 */
	 ...
	 *         minsup have been excluded.
	 */
	public List<String> cloneItemsetMinusItems(List<String> itemset, Map<String, Set<Integer>> mapSequenceID,
