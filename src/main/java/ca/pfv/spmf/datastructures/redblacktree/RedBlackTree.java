...
/**
 * This is an implementation of a "red-black tree" based on the chapter 13 of
 * the book: "Introductions to algorithms" by Cormen et al. (2001). Most of the
 * code is based on the pseudo-code from this book. To understand the details of
 * this implementation, please refer to the book. <br/>
 * <br/>
 * 
 * Elements inserted in the tree have to extend the Comparable class. <br/>
 * <br/>
 * 
...
public class RedBlackTree<T extends Comparable<T>> implements Iterable<T> {
	 ...
	 * Constructor
	 * 
	 * @param allowSameElementMultipleTimes if set to true, this allows the tree to
	 *                                      contains the same element multiple
	 *                                      times. To check if an element is the
	 *                                      same, this class use the compareTo
	 *                                      method
	 */
	...
	/**
	 * Get the successor node of a node (the node having the smallest value larger
	 * than the one of this node).
	 * 
	 * @param x a node
	...
	/**
	 * Get the predecessor node of a node (the node having the largest value smaller
	 * than the one of this node).
	 * 
	 * @param x a node
	...
	/**
	 * Return the node having the largest element having a value lower than a given
	 * element k.
	 */
	...
	/**
	 * Return the node having the largest element having a value higher than a given
	 * element k.
	 */
	 ...
	 * @return The node containing the element or null if the element is not in the
	 *         tree.
	 */
