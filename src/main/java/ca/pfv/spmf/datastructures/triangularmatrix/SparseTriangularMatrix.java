...
/**
 * This class is for creating a triangular matrix of integers by using HashMaps
 * (a sparse matrix rather than a full matrix). See the TriangularMatrixArray
 * class for more details about what is a triangular matrix.
 * 
...
public class SparseTriangularMatrix implements AbstractTriangularMatrix {
	...
	// where the key is an item I, then the value is a map where each entry is a key
	// representing an item J
	...
	/**
	 * This constructor is for compatibility with the other TriangularMatrix
	 * implementation. The parameter "itemCount" is not used.
	 * 
	 * @param itemCount
	 */
	 ...
	 * 
	 * @see
	 * ca.pfv.spmf.datastructures.triangularmatrix.AbstractTriangularMatrix#toString
	 * ()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ca.pfv.spmf.datastructures.triangularmatrix.AbstractTriangularMatrix#
	 * incrementCount(int, int)
	 */
	 ...
	 * 
	 * @see ca.pfv.spmf.datastructures.triangularmatrix.AbstractTriangularMatrix#
	 * setSupport(java.lang.Integer, java.lang.Integer, int)
	 */
