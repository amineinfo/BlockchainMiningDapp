...
/**
 * This class is for creating a triangular matrix of integers represented by
 * using arrays. All the elements in the matrix are initialized to zero and can
 * be changed to other integer values. For example: <br/>
 * <br/>
 * 
 * 0: [0, 0, 0, 0]<br/>
 * 1: [0, 0, 0]<br/>
 ...
 * <br/>
 * 
 * This structure is used by various data mining algorithms such as CHARM and
 * ECLAT.
 * 
