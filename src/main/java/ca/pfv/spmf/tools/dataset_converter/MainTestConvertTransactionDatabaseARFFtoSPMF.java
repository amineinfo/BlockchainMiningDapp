 ...
 * characters are not supported. <br/>
 * <br/>
 * 
 ...
 *        SPMF format:
 * @CONVERTED_FROM_ARFF
 * @RELATION_NAME=sunburn= @ATTRIBUTE=weight=ENUMERATION=blonde=brown=red= @ATTRIBUTE=height=ENUMERATION=short=average=tall= @ATTRIBUTE=weight=ENUMERATION=light=average=heavy= @ATTRIBUTE=lotion=ENUMERATION=yes=no= @ATTRIBUTE=burned=ENUMERATION=burned=none= @ATTRIBUTE=col_17=INTEGER= @ITEM=1=height=average
 * @ITEM=2=weight=light
 * @ITEM=3=lotion=no
 * @ITEM=4=burned=burned @ITEM=5=col_17=1 1 2 3 4 5
 * @ITEM=6=weight=blonde
 * @ITEM=7=height=tall
 * @ITEM=8=weight=average
 * @ITEM=9=lotion=yes
 * @ITEM=10=burned=none @ITEM=11=col_17=2 6 7 8 9 10 11
 * @ITEM=12=weight=brown
 * @ITEM=13=height=short @ITEM=14=col_17=3 8 9 10 12 13 14 @ITEM=15=col_17=4 3 4
 *                       6 8 13 15
 * @ITEM=16=weight=red
 * @ITEM=17=weight=heavy @ITEM=18=col_17=5 1 3 4 16 17 18 @ITEM=19=col_17=6 3 7
 *                       10 12 17 19 @ITEM=20=col_17=7 1 3 10 12 17 20 2 6 9 10
 *                       13 15
 * 
 *                       The first line indicates that this file was obtained by
 *                       a conversion from ARFF to SPMF format. The second line
 *                       indicates the name of the original relational table
 *                       specified in the ARFF file. Each line starting with
 *                       "@attribute" defines an attribute in the table, its
 *                       type and the possible values that the attribute can
 *                       take if the type is "ENUMERATION". For example, the
 *                       attribute "weight" is an enumeration that can take a
 *                       value from "blonde", "brown" or "red". The lines
 *                       starting with "@ITEM= indicates a mapping between a
 *                       unique ID an an attribute value. For example, the line
 *                       "
 * @ITEM=1=height=average " means that the ID 1 represents the value " average"
 *                        for the attribute "height ". Finally, the lines that
 *                        are a list of integers separated by spaces each
 *                        represents a data instances. For example, the line " 1
 *                        2 3 4 5" represents the data instance with the value
 *                        "average " for the attribute " height", the value
 *                        "light" for the attribute " weight", the value " no"
 *                        for the attribute "lotion", the value " burned" for
 *                        the attribute "burned" and the value 1" for the
 *                        attribute "col_17".
 * 
 *                        Note that all lines starting with "@" are metadata
 *                        that are not used by the algorithms in SPMF". But this
 *                        data is kept so that the results found by the
...
class MainTestConvertTransactionDatabaseARFFtoSPMF {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestConvertTransactionDatabaseARFFtoSPMF.class.getResource(filename);
