...
public class TransactionDatasetUtilityGenerator {
	 ...
	 * from the source code.
	 * 
	 * @param input                 the input file path (a transaction database in
	 *                              SPMF format)
	 * @param output                the output file path
	 * @param maxQuantity           the maximum quantity of each item in a
	 *                              transaction
	 * @param externalUtilityFactor the external utility of items generated by
	 *                              Random.nextGaussian() will be multiplied by this
	 *                              value
	 * @throws IOException           if an error while reading/writting files.
	 * @throws NumberFormatException
	 */
	public void convert(String input, String output, int maxQuantity, double externalUtilityFactor)
