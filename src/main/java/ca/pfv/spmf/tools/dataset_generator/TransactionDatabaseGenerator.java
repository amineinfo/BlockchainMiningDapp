...
/**
 * This class is a random transaction database generator such that the user
 * provides some parameters and this class generate a transaction database that
...
public class TransactionDatabaseGenerator {
	...
	/**
	 * This method randomly generates a transaction database according to parameters
	 * provided.
	 * 
	 * @param transactionCount           transaction count the number of
