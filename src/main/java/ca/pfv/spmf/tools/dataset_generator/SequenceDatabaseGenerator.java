...
/**
 * This class is a random sequence database generator such that the user
 * provides some parameters and this class generate a sequence database that is
 * written to the disk.
 * 
...
public class SequenceDatabaseGenerator {
	...
	/**
	 * This method randomly generates a sequence database according to parameters
	 * provided.
	 * 
	 ...
	 * @param output                 the file path for writting the generated
	 *                               database
	 * @param withTimestamps         if true, this database will contain timestamps,
	 *                               otherwise not
	 * @throws IOException
	 */
