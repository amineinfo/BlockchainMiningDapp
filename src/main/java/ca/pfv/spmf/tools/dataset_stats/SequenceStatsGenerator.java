...
/**
 * This class read a sequence database and calculates statistics about this
 ...
 * the statistics. It could be optimized to calculate statistics without reading
	...
	public void getStats(String path) throws IOException {
		...
		try {
			...
			while ((thisLine = myInput.readLine()) != null) {
				...
				// we create a new sequence object to store the sequence that correspond to this
				// line.
		...
		System.out.println("Average number of itemsets per sequence : " + calculateMean(sizes) + " standard deviation: "
				+ calculateStdDeviation(sizes) + " variance: " + calculateVariance(sizes));
		System.out.println("Average number of distinct item per sequence : " + calculateMean(differentitems)
				+ " standard deviation: " + calculateStdDeviation(differentitems) + " variance: "
		...
		System.out.println("Average number of occurences in a sequence for each item appearing in a sequence : "
				+ calculateMean(appearXtimesbySequence) + " standard deviation: "
				+ calculateStdDeviation(appearXtimesbySequence) + " variance: "
				+ calculateVariance(appearXtimesbySequence));
		System.out.println(
				"Average number of items per itemset : " + calculateMean(itemsetsizes) + " standard deviation: "
						+ calculateStdDeviation(itemsetsizes) + " variance: " + calculateVariance(itemsetsizes));
