...
public abstract class DescriptionOfAlgorithm {
	 ...
	 */
	public abstract void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws Exception;

	/**
	 * Get a description of the algorithm's parameters
	 * 
	 * @return a list of AlgorithmParameter objects describing the parameters of the
	 *         algorithm.
	 */
	public abstract DescriptionOfParameter[] getParametersDescription();

	/**
	 * Get at list of file types (Strings) representing the input file format taken
	 * as input by the algorithm.
	 * 
	 * @return a list of file types (Strings) or null if the algorithm does not take
	 *         an input file as input.
	 */
...
//	
	/**
	 * Get at list of file types (Strings) representing the output file format taken
	 * as input by the algorithm.
	 * 
	 * @return a list of file types (Strings) or null if the algorithm does not
	 *         output a file.
	 */
	...
	/**
	 * Check if a given value would be of the correct type as the i-th parameter
