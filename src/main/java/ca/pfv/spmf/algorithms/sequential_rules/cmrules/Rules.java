...
/**
 * This class represents a group of sequential rules returned by the CMRules
 * algorithm.
 *
 * @see AlgoCMRules
 * @see Rule
...
public class Rules {
	...
	public void printRules(int objectsCount) {
		...
		for (Rule rule : rules) {
			...
			System.out.print(" seqConf: " + rule.getSequentialConfidence() + " (" + rule.getAbsoluteSupport() + "/"
