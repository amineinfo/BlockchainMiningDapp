...
/**
 * This class represent a set of occurences in a sequence, as defined in the
 * TRuleGrowth algorithm.
 * 
 * Note that unlike the RuleGrowth algorithms, all occurences in a sequence are
 * kept instead of just the first and last one. This is the main difference
 * between the two implementations of "Occurence".
 * 
 * @see AlgoTRuleGrowth
 * @see Sequence
...
public class Occurence {
	...
	/**
	 * Check if a given Occurence is the same as this one (used to store occurence
	 * in Collections).
	 * 
