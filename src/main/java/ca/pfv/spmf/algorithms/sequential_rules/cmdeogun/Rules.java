...
/**
 * This class represents a group of sequential rules found by the CMDeo
 * algorithm.
 * 
 * @see AlgoCMDeogun
 * @see Itemset
...
public class Rules {
	...
	public void printRules(int objectsCount) {
		...
		for (Rule rule : rules) {
			...
			rule.print();
			// print the support
			System.out.print("support: " + rule.getAbsoluteSupport(objectsCount) + " (" + rule.getRelativeSupport()
					+ "/" + objectsCount + ")  ");
