...
/**
 * This class represent a sequential rule as output by the TNS and TopSeqRules
 * algorithm. <br/>
 * <br/>
 * It is optimized for these algorithms by storing several additional fields
 * that are necessary for such top-k algorithms. For example, a rule includes
 * the transactions IDs of the antecedent, the transaction IDs of the
 * consequent, the transaction IDs of the sequences where the antecedent appears
 * before the consequent, maps of occurences for the antecedent and consequent,
 * etc.
 * 
...
public class Rule implements Comparable<Rule> {
	...
	Set<Integer> tidsJ;
	/**
	 * transaction IDs of the sequences where the antecedent appears before the
	 * consequent
	 */
	Set<Integer> tidsIJ;
	...
	/**
	 * flag indicating if both left and right expansion should be explored from this
	 * rule
	 */
	 ...
	 * @param tidsIJ           transaction IDs of the sequences where the antecedent
	 *                         appears before the consequent
	 ...
	 */
	public Rule(int[] itemset1, int[] itemset2, double confidence, int transactioncount, Set<Integer> tidsI,
			Set<Integer> tidsJ, Set<Integer> tidsIJ, Map<Integer, Short> occurencesIfirst,
			Map<Integer, Short> occurencesJlast) {
	...
	/**
	 * Check if this rule is equal to another (if they have the same items in their
