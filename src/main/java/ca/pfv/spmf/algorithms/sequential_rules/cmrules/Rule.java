...
/**
 * This class represent a rule as found by the CMRules algorithm (an association
 * rules as in Phase 1 of CMRules or a sequential rule as in phase 2 of CMRules.
 * 
 * This class is specially designed for CMRules. It contains the
 * "transactionCount" which is the support as defined in association rule
 * mining, plus the "sequentialTransactionCount" which is the support as defined
 * in sequential rule mining. Besides, each itemset (antecedent and consequent)
 * carry their corresponding transaction ID lists (this is necessary for phase 2
 * of the CMRules algorithm).
 * 
 * @see AlgoCMRules
 * @see Rules
 * @see Itemset
