...
public class SequenceDatabaseWithUtility {
	...
	void addSequence(String[] tokens) {
		...
		// This variable is to count the utility of items that appear twice in the
		// sequence.
		// The reason why we count this, is that HUSRM does not allow items to appear
		// twice or more in the same
		// sequence. Thus, we have to count the extra utility of items appearing more
		// than once and
		// subtract this utility from the utility of the sequence and remove these extra
		// occurrences
		// of items.
		...
		// create a list of double values to store the utility of each item in the
		// current itemset
