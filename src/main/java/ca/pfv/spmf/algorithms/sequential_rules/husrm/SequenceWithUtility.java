...
/**
 * Implementation of a sequence. A sequence is here a list of itemsets. Each
 * itemset contains a set of items, where each item is associated to a utility
 * value.
 *
...
public class SequenceWithUtility {
	...
	// this is the sequence utility (the sum of the utility of each item in that
	// sequence)
	public double exactUtility;

	/**
	 * This method returns the list of utility values for all items in that
	 * sequence.
	 * 
	 * @return A list of list of doubles. The first list represents the itemsets.
	 *         Each itemset is a list of Double where double values indicate the
	 ...
	 * 
	 * @param itemset An itemset (list of integers, where integers represent the
	 *                items)
	 */
	 ...
	 * 
	 * @param utilityValues a list of utility values corresponding to the item of an
	 *                      itemset.
	 */
