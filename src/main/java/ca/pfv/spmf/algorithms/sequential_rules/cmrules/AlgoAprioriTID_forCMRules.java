...
/**
 * This is an implementation of the AprioriTID algorithm that is modified to be
 * used with the CMRules algorithm. AprioriTID was proposed in: <br/>
 * <br/>
 * 
...
//	 a triangular matrix for efficiently counting the support of pairs of items
	 ...
	 * @param mapItemCount       a map indicating the tidset (value) of each item
	 *                           (key)
	 * @return the itemsets of size1
	 */
	protected List<Itemset> createLevelWithFrequentItemsetsSize1(List<Integer> listFrequentsSize1,
			Map<Integer, Set<Integer>> mapItemCount) {
