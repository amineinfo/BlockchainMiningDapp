...
/**
 * This class represent a class sequential rule as output by the
 * TopSeqClassRules algorithm. <br/>
 * <br/>
 * It is optimized for these algorithms by storing several additional fields
 * that are necessary for such top-k algorithms.
 * 
...
public class ClassRule implements Comparable<ClassRule> {
	 ...
	 */
	public ClassRule(int[] itemset1, Integer itemset2, double confidence, int transactioncount, Set<Integer> tidsI,
			Set<Integer> tidsJ, Set<Integer> tidsIJ, Map<Integer, Short> occurencesJlast) {
