...
/**
 * Implementation of a few selection algorithms (randomized select, etc.). based
 * on description from the book "Introduction to Algorithms" from MIT Press.
 * 
...
public class Select {
	...
	/**
	 * Method to select the ith smallest integer of a sub-array in average linear
	 * time. Based on the Randomized-Select algorithm in "Introduction to
	 * algorithms" book by Cormen et al. (2001).
	 * 
...
//		int r = a.length-1;
	 ...
	 * Based on the Randomized-Select algorithm in "Introduction to algorithms" book
	 * by Cormen et al. (2001).
	 * 
	 * @param a array of integers
	 * @param i the i-th value
	 * @return the element of "a" that is larger than i elements.
