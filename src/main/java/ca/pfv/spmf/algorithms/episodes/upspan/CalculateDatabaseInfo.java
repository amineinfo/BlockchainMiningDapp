...
/**
 * Implementation of an algorithm to calculate information about a transaction
 * database with utility information by Wu et al. Obtained from the UP-Miner
 * software under the GPL 3 license.
 * 
	...
	public boolean runCalculate() {
		...
		try {
			...
			while (true) {
				...
				databaseSize++;
				tokens1 = line.split(":"); // divide into 3 parts : 1.itemsets 2.transaction utility 3.utility of each
											// item
			...
			avgLength = (int) ((double) sumAllLength / databaseSize * 100) / 100.0; // accurate to the second decimal
																					// place
			br.close();
