...
/**
 * This class, used by the PrefixSpan algorithm, represents a pair of an (1)
 * item (2) a boolean indicating if the item is contained in an itemset that was
 * cut or not (a postfix). and (3) the sequence IDs containing this item. <br/>
 * <br/>
 * 
 * This class is used by PrefixSpan. <br/>
 * <br/>
 * 
...
class Pair {
	...
	/**
	 * indicate if this represents the item appearing in an itemset that is cut at
	 * the left or not
	 */
