...
/**
 * Class that implements a creator for pairs <item,abstraction> that are used in
...
public class ItemAbstractionPairCreator {
	...
	public ItemAbstractionPair getItemAbstractionPair(Item item, Abstraction_Generic abstraction) {
		// Map<AbstraccionItemGenerica, ItemAbstractionPair> itemPair =
		// poolPares.get(item);
		 ...
		 * FastMap<AbstraccionItemGenerica, ItemAbstractionPair>(); pair = new
