...
/***
 * This is an implementation of a pair of items used by the LAPIN-SPAM algorithm
 * to represent a 2-IE-sequence and its list of positions in a sequence.
 * 
...
public class PairWithList implements Comparable<PairWithList> {
	 ...
	 * @return a value > 0, == 0 or <0 if this pair is larger, equal of smaller than
	 *         the other pair
	 */
