...
/**
 * Implementation of a set of sequential patterns, grouped by their size (how
 * many items they have) as used by the SeqDim and Fournier-Viger(2008)
 * algorithms. Level i = patterns containing i items.
 * 
...
public class Sequences {
	/**
	 * Sequences are organized into levels. In the following list, the position i
	 * (level i) is the list of sequential containing i items.
	 **/
