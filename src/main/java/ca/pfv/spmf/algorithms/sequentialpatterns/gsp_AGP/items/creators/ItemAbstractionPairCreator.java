...
/**
 * Class that implements the pair <item,abstraction> that is used in a pattern
 * implementation.
 * 
...
public class ItemAbstractionPairCreator {
	...
	// private static Map<Item, Map<Abstraction_Generic, ItemAbstractionPair>>
	// pairPool = new HashMap<Item, Map<Abstraction_Generic,
	// ItemAbstractionPair>>();
	...
	public ItemAbstractionPair getItemAbstractionPair(Item item, Abstraction_Generic abstraction) {
		...
		/*
		 * if (itemPair != null) { pair = itemPair.get(abstraction); if (pair == null) {
		 */
		pair = new ItemAbstractionPair(item, abstraction);
		/*
		 * itemPair.put(abstraction, pair); } } else { itemPair = new
		 * HashMap<Abstraction_Generic, ItemAbstractionPair>(); pair = new
		 * ItemAbstractionPair(item, abstraction); itemPair.put(abstraction, pair);
