...
/**
 * This class represents a valued item (an item with a double value) as used by
 * the Fournier-Viger et al. (2008) algorithm. This class extend the Item class
 * in the same package.
 * 
 * @see ItemSimple
 * @see ItemValued
...
public class ItemValued extends ItemSimple {
	...
	/**
	 * Used by Fournier08 algorithm to indicate from which sequence this /** item
	 * come from. It contains a sequence ID.
	 */
	private int sequenceID = -1;

	/**
	 * Variable to indicate a minimum and maximum value. It is used by the
	 * Fournier08 algorithm to indicate the minimum and max value of an item
...
//	}
	...
	/**
	 * Set the sequence ID associated to this item. param sequenceID an interger
	 * value.
	 */
