...
/**
 * Implementation of an MDPatterns Database (as defined in the DIM algorithm of
 * Pinto et al, 2001).
 *
 * @see AlgoDim
 * @see MDPattern
...
public class MDPatternsDatabase {
	...
	/**
	 * Array of values indicating the number of different values for each dimension
	 * [i].
	 */
