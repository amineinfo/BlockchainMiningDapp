...
*/
/**
 * This class represents a projected QMatrix. It consists of an original QMatrix
 * and a set of positions where the current prefix explored by USpan appears.
 * 
...
class QMatrixProjection {
	...
	/**
	 * Get the utility of a cell in the projected q-matrix at a given cell position
	 * (row,column)
	 * 
	...
	/**
	 * Get the remaining utility of a cell in the projected q-matrix at a given cell
	 * position (row,column).
	 * 
	 * @param row    the row
	 * @param column the column
