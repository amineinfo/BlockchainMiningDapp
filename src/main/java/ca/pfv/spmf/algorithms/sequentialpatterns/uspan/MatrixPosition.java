...
*/
/**
 * This class represents a position in a projected q-matrix. It stores the row
 * and column of a q-matrix cell as well as the utility of the current prefix
 * explored by USpan that ends at this cell.
 * 
