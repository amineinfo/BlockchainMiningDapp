...
/**
 * This class represents a sequential pattern found by the PrefixSpan or BIDE
 * algorithm. A sequential pattern is represented by these algorithms as a list
 * of itemsets with an associated hash set indicating the IDS of the sequence
 * containing this sequential pattern.
 * 
...
public class SequentialPattern {
	...
	/**
	 * Get the number of items in this pattern. Note that if an item appear twice,
