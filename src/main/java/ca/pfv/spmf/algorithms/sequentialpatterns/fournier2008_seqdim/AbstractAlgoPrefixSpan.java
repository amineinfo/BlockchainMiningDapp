...
/**
 * This class is an abstract class for PrefixSpan based algorithms that are used
 * with the multi-dimensional sequential pattern mining algorithm SeqDim.
 * 
 * @see AlgoSeqDim
...
public abstract class AbstractAlgoPrefixSpan {
	 ...
	 * @throws IOException if error writing to output file (if user wants to write
