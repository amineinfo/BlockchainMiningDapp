 ...
 * itemset that was cut at left or not (a postfix). (3) if it is contained in an
 * itemset that was cut at right or not (a prefix). and (4) the sequence IDs
 * containing this item.
 * 
 * This class extends the class Pair. It is is used by BIDE+ to count the
 * support of items.
 * 
