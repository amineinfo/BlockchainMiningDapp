...
/**
 * This class is used for debugging some definitions used in the BIDE+ algorithm
 * used with SeqDim. It has no other uses and it should only be used by
 * developpers who want to debug some very specific definition of the BIDE+
 * algorithm about first/last instance, periods, semi-maximum periods... (see
 * the BIDE paper for details).
 * 
...
//		Sequence prefixCAC = createCAC();
		...
		System.out.print("  is  ");
		pseudoSequence.getFirstInstanceOfPrefixSequence(prefix, prefix.getItemOccurencesTotalCount()).pseudoSequence
				.print();
		System.out.println();
		...
		pseudoSequence.print();
		System.out.print("  is  ");
		pseudoSequence.getLastInstanceOfPrefixSequence(prefix, prefix.getItemOccurencesTotalCount()).pseudoSequence
				.print();
		System.out.println();
