...
/**
 * This represents a sequence from a projected database (as used in the
 * PrefixSpan algorithm). A projected sequence keeps a reference to the original
 * sequence and two pointers indicating respectively (1) at which itemset the
 * sequence starts and (2) at which item in this itemset the sequence starts.
 * <br/>
 * <br/>
 * 
 * This class is used by PrefixSpan. The subclass PseudoSequenceBIDE is used by
 * the BIDE algorithm
 * 
...
class PseudoSequence {
	 ...
	 * @param indexItemset the itemset where the pseudo-sequence should start in
	 *                     terms of the original sequence.
	 * @param indexItem    the item where the pseudo-sequence should start in terms
