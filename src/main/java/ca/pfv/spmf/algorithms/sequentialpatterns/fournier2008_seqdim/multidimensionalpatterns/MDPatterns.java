...
/**
 * Implementation of a set of MD-Patterns (as defined in the DIM algorithm by
 * Pinto et al, 2001), sorted by size. <br/>
...
public class MDPatterns {
	...
	/**
	 * a list of list containing the MDPatterns by size For example, the position i
	 * is the list of MD-patterns of size i.
	 */
	 ...
	 * Constructor.
	 * 
	 * @param name a name for the patterns that will be contained in this structure
	 *             (String).
	 */
	 ...
	 * @param k       the size of this md-pattern in terms of the number of
	 *                dimensions
	 */
