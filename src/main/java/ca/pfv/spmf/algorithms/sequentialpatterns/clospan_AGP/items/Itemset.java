...
/**
 * This class represents an itemset from a sequence. The itemset consists of a
 * list of items and an timestamp that denotes when the itemset occurs. An
 * itemset with timestamp is also called "transaction"
 * 
...
public final class Itemset {
	...
	/**
	 * Constructor of an itemset from an array of items and the timestamp associated
	 * with the itemset.
	 * 
	 * @param collection Items that compose the itemset.
	 * @param timestamp  the timestamp associated with the itemset
