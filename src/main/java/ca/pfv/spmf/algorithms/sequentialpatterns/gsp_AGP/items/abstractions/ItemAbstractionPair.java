...
public class ItemAbstractionPair implements Comparable<ItemAbstractionPair> {
	...
	/**
	 * Check if this item is equal to another by checking if both item and
	 * abstraction are identical.
	 * 
	...
	public boolean equals(Object arg) {
		...
		return (this.getItem().equals(itemAbstractionPair.getItem())
				&& this.getAbstraction().equals(itemAbstractionPair.getAbstraction()));
	}
	...
	/**
	 * It compares this item with another and then, if they are equals, their
	 * abstractions.
	 * 
	 * @param arg the other item
	 * @return true if equal, otherwise false
