...
public class TrieNode implements Comparable {
	...
	/**
	 * It compares the TrieNode with either another TrieNode, a ItemAbstractionPair
	 * object or an item. They are compared by their pair components
	 * 
	...
	public int compareTo(Object o) {
		if (o instanceof TrieNode) {
			...
			throw new RuntimeException("Error comparing a TrieNode with an object"
					+ " different from a TrieNode, an ItemAbstractionPair or an" + " item");
		}
	}
