 ...
 * and test if they are sampled from the distributions with the same mean value
 * <br/>
 * <br/>
 * 
 * For more information please refer to the paper Mining Compressing Sequential
 * Patterns in the Journal Statistical Analysis and Data Mining * <br/>
 * <br/>
 * 
...
public class SignTest {
	...
	static final int N = 25; // the minimum number of pairs must be at least 25 to ensure taht the sign test
								// is correct
	...
	double standard_normal_cdf(double xx) {
		...
		if (xx < 0)
			x = -x;
		double b0 = 0.2316419, b1 = 0.319381530, b2 = -0.356563782, b3 = 1.781477937, b4 = -1.821255978,
				b5 = 1.330274429;
		double t = 1 / (1 + b0 * x);
