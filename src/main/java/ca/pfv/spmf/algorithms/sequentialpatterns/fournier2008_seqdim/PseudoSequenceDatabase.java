...
/**
 * This class represents a projected database as used by SeqDim and
 * Fournier-Viger (2008) algorithms. A projected database is a list of
 * pseudoSequences (projected sequences).
 * 
 * @see PseudoSequence
