...
/**
 * Implementation of an MD-Pattern as used by the DIM algorithm proposed by
 * Helen Pinto et al. (2001).
 *
 * @see AlgoDim
 * @see MDPatterns
...
//		System.out.println("((( " + transactioncount);
	...
	/**
	 * Get the relative support of this pattern as a percentage with two decimals
	 * (string)
	 * 
	 * @param databaseSize the database size
	 ...
	 * @return Return 1 if this mdpattern STRICTLY contains mdpattern2 *AND HAVE THE
	 *         SAME SUPPORT* Return 2 if this mdpattern is exactly the same as
	 *         mdpattern2 *AND HAVE THE SAME SUPPORT* Return 0 if this mdpattern
	 *         does not contains mdpattern2.
	 */
