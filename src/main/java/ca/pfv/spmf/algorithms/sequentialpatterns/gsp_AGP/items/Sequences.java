...
public class Sequences {
	...
	/**
	 * Method that give us in a string the content of all Sequences structure in a
	 * SPMF format
	 * 
	...
	/**
	 * It obtains a list of pattern lists, being each pattern list the frequent
	 * sequences with a concrete length For example, at position 1, it is the list
	 * of patterns of size 1. at position 2, it is the list of patterns of size 2
	 * ... etc.
	 * 
	...
	public int size() {
		/*
		 * int total = 0; for (List<Pattern> level : levels) { total = total +
		 * level.size(); } return total;
		 */
