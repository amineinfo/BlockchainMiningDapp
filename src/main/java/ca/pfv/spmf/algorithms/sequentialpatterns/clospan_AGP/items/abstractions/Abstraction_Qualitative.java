...
public class Abstraction_Qualitative extends Abstraction_Generic {
	...
	/**
	 * Abstraction indicating if the item associated has an equal relation with the
	 * previous item in the pattern
	 */
	 ...
	 * itemset and the abstraction is an equal relation, or if the projection starts
	 * in the first item of the itemset and the abstraction does not have an equal
	 * relation.
	 * 
