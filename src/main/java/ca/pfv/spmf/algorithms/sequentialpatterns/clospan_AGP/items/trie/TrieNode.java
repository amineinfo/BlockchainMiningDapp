...
/**
 * Class that implement a bucked for the nodes that are pointed by a Trie. Each
 * node has a pair <abstraction,item> and a child Trie where its children
 * appear.
 *
...
public class TrieNode implements Comparable {
	...
	/**
	 * Trie where the children of this node as well as the informative data related
	 * to the pattern referred by this node appear
	 */
	private Trie child;
	/**
	...
	/**
	 * Update the ItemAbstractionPair component of the TrieNode by the pair given as
	 * parameter
	 * 
	...
	/**
	 * Compare this TrieNode with either another TrieNode or a ItemAbstractionPair
	 * object. They are compared by their pair components
	 * 
