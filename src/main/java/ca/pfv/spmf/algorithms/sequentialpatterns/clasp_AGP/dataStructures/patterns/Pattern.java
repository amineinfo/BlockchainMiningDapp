...
public class Pattern implements Comparable<Pattern> {
	 ...
	 * 
	 * @param outputSequenceIdentifiers show the sequence identifiers where the
	 *                                  pattern appears if true
	 * @return the string representation
	 */
	...
	/**
	 * Compare this pattern with another. Since we always compare elements which
	 * belong to the same equivalence class we only make the comparison of the last
	 * items of both patterns.
	 * 
	...
	/**
	 * It answers if the current Pattern is a subpattern of another one given as
	 * parameter.
	 * 
	 * @param abstractionCreator an abstraction creator
	 * @param p                  pattern to check if it is a superpattern of the
	 *                           current one
