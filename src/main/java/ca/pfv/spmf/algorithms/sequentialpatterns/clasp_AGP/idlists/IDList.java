 ...
 * of IdList, we can create a new one if there we implement the methods here
 * exposed.
 *
...
public interface IDList {
	 ...
	 * sequences with any appearance on it.
	 * 
	 ...
	 * with this IdList appears, and the position items of that sequence where the
