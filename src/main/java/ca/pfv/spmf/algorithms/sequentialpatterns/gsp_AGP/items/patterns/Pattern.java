...
public class Pattern implements Comparable<Pattern> {
	...
	/**
	 * List of elements of a patterns. Concretely it is a list of pairs
	 * <abstraction, item>
	 */
	...
	/**
	 * Constructor that creates a pattern with the only element passed as a
	 * parameter
	 * 
	 * @param pair
	 */
	...
	/**
	 * It answer to the question of if the current pattern is a prefix of the given
	 * pattern
	 * 
