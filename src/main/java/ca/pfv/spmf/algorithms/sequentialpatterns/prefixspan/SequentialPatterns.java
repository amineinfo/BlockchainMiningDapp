...
/**
 * A set of sequential patterns grouped by their size (how many items they
 * have).
 *
...
public class SequentialPatterns {
	...
	public final List<List<SequentialPattern>> levels = new ArrayList<List<SequentialPattern>>(); // itemset classé par
																									// taille
	 ...
	 * 
	 * @param nbObject                the size of the original database in terms of
	 *                                sequences.
