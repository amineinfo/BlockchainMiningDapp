...
/**
 * Implementation of a "Multi-Dimensional Sequence Database" as used by the
 * SeqDim algorithm (Pinto et al., 2001). <br/>
 * <br/>
 * 
 * A MD-Sequences database contains a list of md-Sequences, where each
 * MD-Sequence is composed of an MD-Pattern and a Sequence.
 * 
 * @see MDSequence
 * @see MDSequences
 * @see AlgoSeqDim
...
public class MDSequenceDatabase {
	...
	/**
	 * We also keep the sequences and patterns in some separate databases. // the
	 * sequence database
	 */
