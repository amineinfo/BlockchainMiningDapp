...
/**
 * This class represents a set of sequential patterns found either by the
 * PrefixSpan or BIDE+ algorithms, grouped by their size (how many items they
 * have).
 *
 * @see Itemset
...
public class SequentialPatterns {
	 ...
	 */
	private final List<List<SequentialPattern>> levels = new ArrayList<List<SequentialPattern>>(); // itemset classé par
																									// taille
	 ...
	 * 
	 * @param nbObject the number of sequences in the database where these patterns
	 *                 were found.
	 * @return a string
	 */
	...
	/**
	 * Get a list of list of sequential patterns such that at position i, there is a
	 * list of sequential patterns containing i items.
	 * 
