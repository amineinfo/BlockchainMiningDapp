...
/**
 * Implementation of a "MultiDimensional-Sequence" used by the SeqDim algorithm
 * (Pinto et al., 2001). <br/>
 * <br/>
 * An MD-Sequence is associated to a MD-Database. <br/>
 * <br/>
 * An MD-Sequence has two parts: an mdpattern (the values for each dimension)
 * and a sequence.
 * 
...
//		System.out.println("((( " + transactioncount);
	...
	/**
	 * Get the support of this MD-sequence as a percentage with five decimals
	 * (String)
	 * 
	 * @param databaseSize the database size
	 * @return the support as a double
