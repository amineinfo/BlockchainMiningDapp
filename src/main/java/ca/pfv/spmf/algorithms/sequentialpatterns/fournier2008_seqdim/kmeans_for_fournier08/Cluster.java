...
/**
 * This class represents a Cluster for the Kmeans version used by the
 * Fournier-Viger-2008 algorithm.
 * 
 * It is different from the general K-Means implementation in the package
 * "clustering" in that it is designed to use valued item (an item with a value)
 * rather than clustering vectors of double values. It also keep the average,
 * higher and lower values of each clusters.
 * 
...
public class Cluster {
	...
	/**
	 * Get the item ID associated to this cluster (for use with the Fournier-Viger
	 * 08 algorithm).
	 * 
	 * @return the item ID
	 */
	...
	/**
	 * Set the set of sequence IDs corresponding to this cluster param sequenceIDs a
	 * set of sequence IDs.
	 */
