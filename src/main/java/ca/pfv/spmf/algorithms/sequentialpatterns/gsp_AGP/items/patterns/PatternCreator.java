...
/**
 * This class is the implementation of a creator of patterns. By means this
 * class, different kind of patterns can be used for this algorithm.
 * 
...
public class PatternCreator {
	...
	// private static Map<Pattern, Pattern> patternPool = new HashMap<Pattern,
	// Pattern>();
	...
	public Pattern createPattern(List<ItemAbstractionPair> elements) {
		...
		/*
		 * Pattern existingPattern = patternPool.get(newPattern); if (existingPattern ==
		 * null) { existingPattern = newPattern; patternPool.put(newPattern,
		 * newPattern); } return existingPattern;
		 */
		return newPattern;
	}
