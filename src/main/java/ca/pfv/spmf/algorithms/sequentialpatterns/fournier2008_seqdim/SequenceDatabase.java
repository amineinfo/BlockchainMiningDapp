...
/**
 * Implementation of a sequence database as used by the SeqDim and Fournier-Vier
 * (2008) algorithms. Each sequence need to hvae a unique ID. See examples in
 * the /test/ directory for the format of input files. that can be read by this
 * class.
 * 
