 ...
 * <abstraction, item>. Besides, a bitSet appearingIn denotes the sequences
...
public class Pattern implements Comparable<Pattern> {
	 ...
	 * 
	 * @param outputSequenceIdentifiers if true sequence id will be shown for this
	 *                                  pattern
	 * @return the string representation
	 */
	...
	/**
	 * It adds an item with its abstraction in the pattern. The new pair is added in
	...
	/**
	 * Check if this pattern is equal to another according to the lexicographic
	 * order.
	 * 
	 ...
	 */
	/*
	 * public List<Integer> getAppearingIn() { return appearingIn; }
	 */
	...
	/**
	 * Check if the current Pattern is a subpattern of another one given as
	 * parameter.
	 * 
	...
	/**
	 * Get the sum of all the sequence identifiers that are present in the support
	 * of this pattern.
	 * 
	...
	/**
	 * Set the value for the addition of all the sequence identifiers that are
	 * present in the support of this pattern
	 * 
