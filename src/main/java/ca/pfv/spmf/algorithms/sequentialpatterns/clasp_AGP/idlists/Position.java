...
/**
 * This class represents a position of an item in a sequence. Each item position
 * is indicated by two values, an itemset index (the itemset where the item
 * appears), and the position of the item within that itemset.
 * 
