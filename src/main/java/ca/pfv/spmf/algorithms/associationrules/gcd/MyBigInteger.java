...
public class MyBigInteger implements Comparable<MyBigInteger> {
	...
	/**
	 * Multiplication of integers is fast and utilized here till it overflows The
	 * moment it overflows, all further multiplication operations are carried out
	 * using the BigInteger functions The factors list is always updated in order to
	 * speed up the rest of the operations
	 */
