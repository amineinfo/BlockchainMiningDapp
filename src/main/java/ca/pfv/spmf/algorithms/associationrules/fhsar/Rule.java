...
/**
 * This class is an association rule implementation optimized for the FHSAR
 * algorithm for association rule hiding. <br/>
 * <br/>
 * A rule stores its support as well as the support of its antecedent. The
 * antecedent and consequent are stored as as Set of Integers for fast inclusion
 * checking.
 * 
 * @see AlgoFHSAR
