...
/**
 * This is an implementation of the GEN-IGB-FERMES algorithm for mining the IGB
 * basis of association rules. <br/>
 * <br/>
 * 
 * This algorithm is described in the article (in French) : "IGB : une nouvelle
 * base g�n�rique informative des r�gles d�association" dans
 * Information-Interaction-Intelligence (Revue I3), vol. 6, n� 1,
 * C�padu�s-�ditions, pp. 31-67, octobre 2006 <br/>
 * <br/>
 * 
 * This algorithm generates the IGB basis of association rules from the set of
 * frequent closed itemsets, their support and their associated minimal
 * generators. <br/>
 * <br/>
 * 
 * This algorithm can save the result to a file or keep it into memory if the
 * user provides a null output file path to the runAlgorithm() method.
 *
...
public class AlgoIGB {
	 ...
	 * @throws IOException
	 */
	public Rules runAlgorithm(TZTableClosed closedPatternsAndGenerators, int databaseSize, double minconf,
...
//			Rule rule = new Rule(, i, i.getAbsoluteSupport(), i.getRelativeSupport(databaseSize)); // 4,5,6
	...
	private void save(Itemset itemset1, Itemset itemset2, int absoluteSupport, double confidence) throws IOException {
		...
		if (writer != null) {
			...
			Rule rule = new Rule(itemset1.getItems(), itemset2.getItems(), itemset1.support, absoluteSupport,
					confidence);
			rules.addRule(rule);
		}
	}
