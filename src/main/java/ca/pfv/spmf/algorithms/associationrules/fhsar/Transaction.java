...
/**
 * This class represent a transaction from a transaction database. This
 * implementation is defined and optimized for the FHSAR algorithm for
...
class Transaction implements Comparable<Transaction> {
	...
	@Override
	/**
	 * Compare this transaction with a given transaction according to their wi
	 * values. If they have the same wi values, we use the hashcode.
	 * 
