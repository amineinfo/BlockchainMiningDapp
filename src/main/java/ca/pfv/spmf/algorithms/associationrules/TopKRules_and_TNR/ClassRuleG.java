...
/**
 * This class represents an association rule found by the TopKClassRules
 * algorithm for top-k class association rule mining. <br/>
 * <br/>
 * 
 ...
 * integers. Lastly, for optimization, the maximum item id of the antecedent is
 * precalculated and kept (as explained in the paper).
 * 
