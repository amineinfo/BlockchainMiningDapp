...
/**
 * This class represents a transaction database optimized for the TNR and
 * TopKRules algorithms for top-k association rule mining. <br/>
 * <br/>
 * 
 * It contains a list of transaction implemented as linked-lists and keep track
 * of the largest item ids and the total number of transactions in the database.
 * <br/>
 * <br/>
 * 
 * The main method is loadFile() for reading a file. But transactions can also
 * be added manually by calling the method addTransaction.
 * 
 * @see AlgoTNR
 * @see AlgoTopKRules
 * @see Transaction
...
public class Database {
	 ...
	 * 
	 * @param itemsString an array of items, where an item is an integer represented
	 *                    as a String.
	 */
