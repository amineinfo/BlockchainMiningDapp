 ...
 * algorithms for top-k association rule mining. In particular transactions are
 * implemented as LinkedList for efficient removal of infrequent items as done
 * by these algorithms.
 * 
 * @see AlgoTNR
 * @see AlgoTopKRules
