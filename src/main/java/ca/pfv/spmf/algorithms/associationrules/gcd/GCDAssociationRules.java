...
public class GCDAssociationRules {
	...
	public void runAlgorithm() throws Exception {
		...
		System.out.println("Confidence values time (ms): " + (Calendar.getInstance().getTimeInMillis() - startTimestamp
				- gcdsExtractionTime - supportCalculationTime));
	...
	/**
	 * This algorithm can be parallelized in many of its phases. So this function is
	 * made to utilize the processing power of multiple cores by maintaining a
	 * constant number of threads that equals the number of cores
	 */
