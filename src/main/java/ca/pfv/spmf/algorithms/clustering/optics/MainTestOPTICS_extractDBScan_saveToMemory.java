...
/**
 * Example of how to use the OPTICS algorithm to extract DBScan-style clusters,
 * in the source code and keep the result in memory.
 */
public class MainTestOPTICS_extractDBScan_saveToMemory {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		// We specify that in the input file, double values on each line are separated
		// by spaces
		String separator = " ";
