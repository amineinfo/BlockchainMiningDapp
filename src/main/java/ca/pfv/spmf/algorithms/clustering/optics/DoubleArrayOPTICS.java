...
public class DoubleArrayOPTICS extends DoubleArrayInstance implements Comparable<DoubleArrayOPTICS> {
	 ...
	 */
	public void setCoreDistance(List<KNNPoint> neighboors, double epsilon, int minPts) {
	 ...
	 * @return an integer <0 if the distance of this point is smaller than the
	 *         distance of point2 an integer >0 if the distance of this point is
	 *         larger than the one of point2 0 if the distance is the same.
	 */
