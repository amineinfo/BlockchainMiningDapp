...
/**
 * This class reads an instance file in memory. This is the type of files used
 * by clustering algorithms, for example.
 * 
...
public class AlgoInstanceFileReader {
	 ...
	 * @return a list of DoubleArray (vectors of double values), each representing
	 *         an instance.
	...
	public List<DoubleArray> runAlgorithm(String input, String separator) throws IOException {
		...
		while ((thisLine = myInput.readLine()) != null) {
			...
			// Then, we convert to a double array containing each data point of the time
			// series
