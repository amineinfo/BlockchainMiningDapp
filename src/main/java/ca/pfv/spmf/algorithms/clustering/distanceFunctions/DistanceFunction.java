...
/**
 * This class represent a distance function to calculate the distance between
 * two arrays of double values. It is an abstract class having several
 * subclasses such as the Euclidian distance and the Manathan distance. The
 * distance classes are used by the clustering algorithm. It let the user choose
 * which distance measure should be used. <br/>
 * <br/>
 * 
