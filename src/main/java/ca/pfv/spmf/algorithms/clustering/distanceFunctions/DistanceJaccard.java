...
*/
/**
 * This class implements the Jaccard distance function. This distance function
 * is suitable for vectors of binary values (0 or 1). It should not be used with
 * vectors containing non binary numbers. It is a subclass of the
 * DistanceFunction class which represents any distance function. <br/>
 * <br/>
 * 
