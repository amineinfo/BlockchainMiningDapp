...
/**
 * An algorithm to calculate the standardization of a time series. The purpose
 * of using this algorithm is to transform a time series such that all values
 * are standardized (have a mean of 0 and a standard deviation of 1). Each value
 * y is replaced by: y = x - mean / standard_deviation
 * 
...
public class AlgoStandardization {
	...
	/**
	 * Generate the standardization of a time series containing at least 1 data
	 * point.
	 * 
