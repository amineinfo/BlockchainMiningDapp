...
/**
 * Example of how to calculate the simple linear regression of one or more time
 * series using the source code of SPMF, by reading a time series file and
 * writing the regression line (a time series) as output in a file
 * 
