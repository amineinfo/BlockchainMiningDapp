...
/**
 * Example of how to calculate the autocorrelation function of a time series,
 * using the source code of SPMF
 * 
...
public class MainTestAutocorrelation {
	...
	public static void main(String[] arg) throws IOException {
		...
		// the maximum lag to be used to generate the k-lag autocorrelation plot of a
		// time series.
		int maxlag = 16;

		// Create a time series
		double[] dataPoints = new double[] { 3.0, 2.0, 8.0, 9.0, 8.0, 9.0, 8.0, 7.0, 6.0, 7.0, 5.0, 4.0, 2.0, 7.0, 9.0,
				8.0, 5.0 };
