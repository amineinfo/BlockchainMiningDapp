...
/**
 * An algorithm to calculate the simple linear regression of a time series using
 * the least squares method. This generates a model of the form y(x) = bias +
 * coefficient * x.
 * 
...
public class AlgoTimeSeriesLinearRegressionLeastSquare {
	...
	/**
	 * Train a linear regression model for a given time series using the least
	 * squares method.
	 * 
	 ...
	 * @param the    regression line corresponding to the time series (a TimeSeries
	 *               object)
	 */
	...
	/**
	 * Generate a simple regression of a time series (an equation of the form y =
	 * bias + coefficient*x
	 * 
	...
	/**
	 * Perform a prediction using the current regression model. This assumes that
	 * the model has been trained using the calculateRegression() method.
	 * 
	 * @param x a double value
	 * @return a prediction calculating using the model y(x) = bias + coefficient *
	 *         x, or 0 if the model has not been trained.
	 */
	...
	/**
	 * Get the bias of the trained model. This assumes that the model has been
	 * trained using the calculateRegression() method.
	 * 
	 * @return the bias of the equation y(x) = bias + coefficient * x, or 0 if the
	...
	/**
	 * Get the coefficient of the trained model. This assumes that the model has
	 * been trained using the calculateRegression() method.
	 * 
	 * @return the coefficient of the equation y(x) = bias + coefficient * x, or 0
