...
/**
 * An algorithm to calculate the prior moving average of a time series. The
 * prior moving average for a point is computed as the average of the
 * "windowSize" prior points (it excludes the current point from the average).
