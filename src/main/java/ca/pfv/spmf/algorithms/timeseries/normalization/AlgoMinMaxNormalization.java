...
/**
 * An algorithm to calculate the min max normalization of a time series. The
 * purpose of using this algorithm is to transform a time series such that all
 * values are in the [0,1] interval. Each value y is replaced by: y' = (y - min)
 * / (max - min).
 * 
...
public class AlgoMinMaxNormalization {
	...
	/**
	 * Generate the min max normalization of a time series containing at least 1
	 * data point.
	 * 
