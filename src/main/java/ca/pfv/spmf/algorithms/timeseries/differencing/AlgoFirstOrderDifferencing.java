...
/**
 * An algorithm to calculate the first order differencing of a time series. The
...
public class AlgoFirstOrderDifferencing {
	...
	/**
	 * Generate the first order differencing of a time series containing at least
	 * two data points.
	 * 
	...
	public TimeSeries runAlgorithm(TimeSeries timeSeries) throws IOException {
		...
		if (timeSeries.size() < 2) {
			throw new IllegalArgumentException(
					" The time series should contain at least 2 points to apply differencing.");
		}
