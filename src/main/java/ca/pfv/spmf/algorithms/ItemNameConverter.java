...
/**
 * This class is used to rename items in a datasets. It is used by several
 * algorithms that use a total order, which is different from the alphabetical
 * or lexicographical order. By renaming items with consecutive names, it allows
 * several optimization such as faster comparison between items by using the > <
 * == operators.
 *
...
public class ItemNameConverter {
	...
	/**
	 * This structure is used for converting new names to old names. The i-th
	 * position contains the old item name corresponding to the new name "i"
	 **/
	int[] newNamesToOldNames;
	/**
	 * This structure is used for converting old names to new names. The key is an
	 * old name. The value is a new name
	 **/
	 ...
	 * @return the corresponding new name or null, if no new name exists for that
	 *         old name.
	 */
