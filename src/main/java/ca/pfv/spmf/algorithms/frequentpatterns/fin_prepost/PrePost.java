...
public class PrePost {
	...
	// if this parameter is set to true, the PrePost+ algorithm is run instead of
	// PrePost
	 ...
	 * instead of PrePost.
	 * 
	 * @param usePrePostPlus if true, PrePost+ will be run instead of PrePost when
	 *                       executing the method runAlgorithm()
	 */
