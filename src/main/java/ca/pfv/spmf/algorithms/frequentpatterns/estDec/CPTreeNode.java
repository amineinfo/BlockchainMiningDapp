...
/**
 * This is an implementation of a CPTree node. <br\> <br\>
 * 
 * This implementation was made by Azadeh Soltani <br\> <br\>
 * 
...
public class CPTreeNode {
	...
	/**
	 * Return the immediate index of itemIDList of this node having a given ID. If
	...
	public short getInnerIndexWithID(int id, CPTreeNode parentNode, short parentInd) {
		...
		for (short i = (short) (parentInd + 1); i < itemIDList.size(); ++i)
			if (itemIDList.get(i) == id && parents.get(i).pNode == parentNode && parents.get(i).pInd == parentInd)
				return i;
		return (short) -1;
	}
	...
	/**
	 * if the itemID is the leaf level node return true else return false;
	 * 
	 * @param id
	 */
