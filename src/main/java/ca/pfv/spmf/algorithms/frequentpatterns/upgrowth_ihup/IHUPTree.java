...
/**
 * This is an implementation of the IHUP-Tree used by IHUP algorithm. Copyright
 * (c) 2014 Prashant Barhate
 * 
...
public class IHUPTree {
	 ...
	 * order of TWU.
	 * 
	 * @param mapItemToTWU the Utilities of each item (key: item value: TWU or path
	 *                     utility)
	 */
