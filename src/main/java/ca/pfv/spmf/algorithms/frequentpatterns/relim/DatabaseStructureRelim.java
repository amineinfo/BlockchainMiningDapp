...
/**
 * This class represents a transaction database optimized for the RELIM
 * algorithm. In particular, the transaction database is represented by a list
 * of list of list of integers (items) and the support of each item is
 * calculated and stored in an interna array.
 * 
 * @see AlgoRelim
...
class DatabaseStructureRelim {
	...
	// the transactions structure of the relim algorithm (see paper for full
	// details)
