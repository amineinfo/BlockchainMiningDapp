...
/**
 * This is an implementation of the "MinFHM" algorithm for Minimal High-Utility
 * Itemsets Mining as described in the conference paper : <br/>
 * <br/>
 * 
 * Fournier-Viger, P., Lin, C.W., Wu, C.-W., Tseng, V. S., Faghihi, U. (2016).
 * Mining Minimal High-Utility Itemsets. Proc. 27th Intern. Conf. on Database
 * and Expert Systems Applications (DEXA 2016). Springer, LNCS, 13 pages, to
 * appear
 *
 * @see UtilityList
 * @see Element
...
public class AlgoMinFHM {
	...
	/**
	 * Check if there exists an itemset smaller than a given itemset in the
	 * MinHUI-Store
	 * 
	...
	public boolean isSubsumingAFoundItemset(int[] itemset) {
		// THIS IS AN OPTIMIZATION.... SINCE ITEMSETS OF SIZE 1 ARE NOT IN THE
		// MINHUI-STORE,
...
//		System.out.println();
	...
	/**
	 * This method insert an itemset of size k > 1 in the store and remove its
	 * supersets
	 * 
...
//		System.out.println();
	...
	public void runAlgorithm(String input, String output, int minUtility) throws IOException {
		...
		for (Integer item : mapItemToTWU.keySet()) {
			...
			// and its utility is lower than minutil, we create the utility list of that
			// item
...
//		buffer.append(itemset.support);
	...
	/**
	 * Method to write a high utility itemset to the output file, that contains a
	 * single item.
	 * 
	 * @param the     prefix to be writent o the output file
	 * @param an      item to be appended to the prefix
