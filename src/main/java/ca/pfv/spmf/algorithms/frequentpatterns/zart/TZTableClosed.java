...
/**
 * This class represents the TZ table containing the closed itemsets and their
 * generators, used by the Zart algorithm.
 *
 * @see AlgoZart
...
public class TZTableClosed {
	...
	/**
	 * This store the closed itemsets by size At position i, there are the list of
	 * closed itemsets of size i
	 */
