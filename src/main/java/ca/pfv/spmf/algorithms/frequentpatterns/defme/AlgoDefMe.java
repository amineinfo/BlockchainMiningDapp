...
public class AlgoDefMe {
	 ...
	 *                      frequentItems.size()-1] in "frequentItems".
	 * @param critItemsetX  The critical objects of each item from the itemset X,
	 *                      stored in an array.
	 * @throws IOException if an error occured while writing result to disk
	 */
	private void defme(int[] itemsetX, int itemsetLength, BitSet tidsetX, int supportX, List<Integer> frequentItems,
			int posTail, BitSet[] critItemsetX) throws IOException {
