...
/**
 * This class implements the Phase 2 of the CHUD algorithm for closed high
...
class AlgoCHUD_Phase2 {
	 ...
	 * @param filePathOutput          the path of the final output file for the
	 *                                results
	 * @param minUtility              the minimum utility thrsehold
	 * @param phase2SaveHUIsInOneFile if true all results should be saved in a
	 *                                single file
	 * @throws IOException if some error occurs while reading/writing results to a
	 *                     file
	 */
	public void runAlgorithm(String path, String filePathPhase1, String filePathOutput, int minUtility,
			boolean phase2SaveHUIsInOneFile) throws IOException {
...
//				buffer.append(tidsetStr.length);
	 ...
	 * 
	 * @param maximumNumberOfTransactions the number of transaction (a positive
	 *                                    integer)
	 */
