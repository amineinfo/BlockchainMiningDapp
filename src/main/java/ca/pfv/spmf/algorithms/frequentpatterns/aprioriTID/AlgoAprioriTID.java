...
/**
 * This is an implementation of the AprioriTID algorithm.<br/>
 * <br/>
 * 
 * The AprioriTID algorithm finds all the frequents itemsets and their support
 * in a binary context.<br/>
 * <br/>
 * 
 * AprioriTID can be faster than Apriori and produce the same result. <br/>
 * <br/>
 * 
 ...
 * <br/>
 * 
 * This implementation can save the result to a file or keep it into memory if
 * no output path is provided to the runAlgorithm() method. <br/>
 * <br/>
 * 
 * @see Itemset
 * @see Itemsets
...
public class AlgoAprioriTID {
	 ...
	 * @throws IOException exception if error reading/writing the file
	 */
	public Itemsets runAlgorithm(String input, String output, double minsup) throws NumberFormatException, IOException {
		// record start time
