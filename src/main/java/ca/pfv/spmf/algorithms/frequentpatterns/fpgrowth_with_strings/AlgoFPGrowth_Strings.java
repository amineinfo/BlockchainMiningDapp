...
//	}
	 ...
	 * @param mapSupport a map for storing the support of each item (key: item,
	 *                   value: support)
	 * @throws IOException exception if error while writing the file
	 */
	...
	private void fpgrowth(FPTree_Strings tree, String[] prefixAlpha, int prefixSupport, Map<String, Integer> mapSupport)
		...
		if (tree.hasMoreThanOnePath == false) {
			...
			// add all combinations of this path, concatenated with the prefix "alpha", to
			// the set of patterns found.
	...
	private void fpgrowthMoreThanOnePath(FPTree_Strings tree, String[] prefixAlpha, int prefixSupport,
		...
		// We process each frequent item in the header table list of the tree in reverse
		// order.
	...
	/**
	 * This method is for adding recursively all combinations of nodes in a path,
	 * concatenated with a given prefix, to the set of patterns found.
	 * 
