 ...
 * <br/>
 * 
 * RELIM is not a very efficient frequent itemset mining algorithm, but I
 * decided to implement it because it is simple.<br/>
 * <br/>
 * 
 * Note that it might not be implemented in a very optimized way. One reason is
 * that in the original article there is no pseudo-code for the algorithm.
 *
