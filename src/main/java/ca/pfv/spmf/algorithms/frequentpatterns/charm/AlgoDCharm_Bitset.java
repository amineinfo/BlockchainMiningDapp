...
/**
 * This is an implementation of the dCharm algorithm. The difference between
 * DECLAT and CHARM is that dCharm utilizes diffsets instead of tidsets. In this
 * implementation, diffsets are represented as bitsets. Note that this class is
 * a subclass of the Charm algorithm because a lot of code is the same and we
 * wanted to avoid redundancy.
 * 
 * IMPORTANT: dCharm returns Itemsets annotated with their diffsets rather than
 * tidsets when the user choose to keep the result in memory.
 * 
 * dCharm was proposed by ZAKI (2000). <br/>
 * <br/>
 * 
 * See this article for details about dCharm: <br/>
 * <br/>
 * 
 * Mohammed Javeed Zaki, Ching-Jiu Hsiao: CHARM: An Efficient Algorithm for
 * Closed Itemset Mining. SDM 2002. * <br/>
 * <br/>
 * 
 * and diffsets have been proposed in: <br/>
 * <br/>
 * 
 * M. J. Zaki and K. Gouda. Fast vertical mining using Diffsets. Technical
 * Report 01-1, Computer Science Dept., Rensselaer Polytechnic Institute, March
 * 2001.
 * 
...
public class AlgoDCharm_Bitset extends AlgoCharm_Bitset {
	...
	/**
	 * Perform the intersection of two diffsets for itemsets containing more than
	 * one item.
	 * 
