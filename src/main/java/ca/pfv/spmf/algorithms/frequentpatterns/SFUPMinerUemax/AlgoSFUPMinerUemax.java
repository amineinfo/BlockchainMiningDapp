...
/**
 * * * * This is an implementation of the skyline frequent-utility patterns
 * mining algorithm using uemax array.
 * 
...
public class AlgoSFUPMinerUemax {
	...
	private void SFUPMiner(int[] prefix, UtilityList pUL, List<UtilityList> ULs, SkylineList psfupList[],
			List<Skyline> skylineList, int[] uEmax) throws IOException {
