 ...
 * <br/>
 * 
 * Grahne, G., & Zhu, J. (2005). Fast algorithms for frequent itemset mining
 * using fp-trees. Knowledge and Data Engineering, IEEE Transactions on, 17(10),
 * 1347-1362. * <br/>
 * <br/>
 * 
 * This is a version that saves the result to a file or keep it into memory if
 * no output path is provided by the user to the runAlgorithm method().
 * 
 * I have tried to follow the paper as much as possible. However, I did not use
 * the FPArray optimization
 *
 * @see FPTree
 * @see Itemset
 * @see Itemsets
...
public class AlgoFPClose {
	...
	// If set to true, the algorithm will show information for debugging in the
	// console
	private final boolean DEBUG = false;

	// Comparator to compare the items based on the order of decreasing support in
	// the original DB.
	...
	public Itemsets runAlgorithm(String input, String output, double minsupp)
		...
		// (1) PREPROCESSING: Initial database scan to determine the frequency of each
		// item
...
//		System.out.println(tree);
	 ...
	 */
	private void fpclose(FPTree tree, int[] prefix, int prefixLength, int prefixSupport,
...
//		======= DEBUG ========
		...
		// This variable is used to count the number of items in the single path (if
		// there
