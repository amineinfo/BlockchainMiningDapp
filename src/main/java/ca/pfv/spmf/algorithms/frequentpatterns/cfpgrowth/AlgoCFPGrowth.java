...
//	// end az-------------------------------------------------------------------
	 ...
	 */
	private void cfpgrowth(MISTree tree, int[] prefixAlpha, int prefixSupport, Map<Integer, Integer> mapSupport)
			throws IOException {
	 ...
	 */
	private void cfpgrowthMoreThanOnePath(MISTree tree, int[] prefixAlpha, int prefixSupport,
