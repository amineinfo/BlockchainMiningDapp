...
public class UPTreePlus {
	...
	/**
	 * Method for adding a transaction to the up-tree (for the initial construction
	 * of the UP-Tree).
	 *
	 ...
	 */
	public void addLocalTransaction(List<Integer> localPath, int pathUtility, Map<Integer, Integer> mapMiniNodeUtility,
			int pathCount) {
	 ...
	 *
	 * @param mapItemToEstimatedUtility the Utilities of each item (key: item value:
	 *                                  TWU or path utility)
	 */
	void createHeaderList(final Map<Integer, Integer> mapItemToEstimatedUtility) {
		...
		Collections.sort(headerList, new Comparator<Integer>() {
			public int compare(Integer id1, Integer id2) {
				// compare the Utility
				int compare = mapItemToEstimatedUtility.get(id2) - mapItemToEstimatedUtility.get(id1);
