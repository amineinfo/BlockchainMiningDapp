 ...
 * <br/>
 * 
 * Djenouri, Y., Comuzzi, M. and Djenouri, D., 2017, May. SS-FIM: Single Scan
 * for Frequent Itemsets Mining in Transactional Databases. In Pacific-Asia
 * Conference on Knowledge Discovery and Data Mining (pp. 644-654). Springer.
 * <br/>
 * <br/>
 * 
 * @see Itemset
...
public class AlgoSSFIM {
	...
	/**
	 * buffer for storing the current transaction that is read from the file to
	 * reduce memory usage.
	 **/
