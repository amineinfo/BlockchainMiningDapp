...
/**
 * This is an implementation of the "FCHM_allconfidence" algorithm for
 * High-Utility Itemsets Mining as described in the conference paper : <br/>
 * <br/>
 * 
...
//					int remain = remainingUtility; // FOR OPTIMIZATION
	 ...
	 * @param pUL               This is the Utility List of the prefix. Initially,
	 *                          it is empty.
	 * @param ULs               The utility lists corresponding to each extension of
	 *                          the prefix.
	 ...
	 * @throws IOException
	 */
	private void fchm(int[] prefix, int prefixLength, UtilityListFCHM_all_confidence pUL,
			List<UtilityListFCHM_all_confidence> ULs, int minUtility, double minAll_confidence) throws IOException {
	 ...
	 */
	private UtilityListFCHM_all_confidence construct(UtilityListFCHM_all_confidence P,
			UtilityListFCHM_all_confidence px, UtilityListFCHM_all_confidence py, int minUtility) {
	 ...
	 */
	private void writeOut(int[] prefix, int prefixLength, int item, long utility, double all_confidence)
			throws IOException {
