...
/**
 * This class contains methods that are shared by the Itemset-Tree and
 * Memory-Efficient Itemset Tree Implementations.
 * 
...
abstract class AbstractItemsetTree {
	 ...
	 * @return a new itemset which is the largest common ancestor or null if it is
	 *         the empty set
	 */
