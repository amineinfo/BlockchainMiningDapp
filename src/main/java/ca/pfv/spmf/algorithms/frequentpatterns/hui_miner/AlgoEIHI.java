...
/**
 * This is an implementation of the "EIHI" algorithm by Fournier-Viger et al.
 * (2015).
 * 
 * @see UtilityListEIHI
 * @see Element
...
public class AlgoEIHI {
	 ...
	 * ordering in the following map because if the ordering change in an updated
	 * database, then the result may be incorrect.
	 */
	Map<Integer, Integer> mapItemToRank;

	/**
	 * The EUCS structure, as described in the FHM paper It stores pairs of items
	 * and their coresponding TWU.
	 */
	Map<Integer, Map<Integer, Integer>> mapEUCS;

	/**
	 * If this variable is set to true, this algorithm will show debuging
	...
	class Pair {
		...
		/**
		 * Return a String representation of this "pair" object. This is useful for
		 * debuging.
		 * 
	...
	/**
	 * Get the number of HUIs stored in the HUI-trie structure. This is performed by
	 * scanning the HUI-Trie and checking which itemsets are HUIs.
	 * 
	...
	/**
	 * This is a helper method to count the number of HUIs stored in the HUI-trie
	 * structure.
	 * 
	 * @param a list of nodes to explore in a depth-first search way to count the
	 *          HUIs.
	 * @return the number of HUIs.
	 */
	 ...
	 * @param the  current prefix, which is the concatenation of all items in the
	...
	/**
	 * Write HUIs found to a file. Note that this method write all HUIs found until
	 * now and erase the file by doing so, if the file already exists.
	 * 
	...
	public void printTrie() {
		...
		// call a recursive helper method to print the trie in a depth-first search way
		// starting
	 ...
	 * 
	 * @param list a list of nodes to explore in a depth-first search way
	 * @param an   indentation consisting of a set of tabulations to indent the
	 *             branches of the tree in the console.
	 */
...
//		return true;
	...
	// NOTE : This variable used by the binary search has been made global so that
