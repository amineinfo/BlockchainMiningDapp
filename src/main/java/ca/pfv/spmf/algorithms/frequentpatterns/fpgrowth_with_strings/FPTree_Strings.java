...
/**
 * This is an implementation of a FPTree for the version of FPGrowth where items
 * are represented by Strings rather than Integers.
 *
 *
 * @see FPNode_Strings
 * @see FPTree_Strings
...
public class FPTree_Strings {
	...
	/**
	 * Mehod for creating the list of items in the header table, in descending order
	 * of frequency.
	 * 
