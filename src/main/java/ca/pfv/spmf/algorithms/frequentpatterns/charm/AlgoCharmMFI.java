...
public class AlgoCharmMFI {
	 ...
	 * 
	 * @param output         an output file path or null if the user want to keep
	 *                       the result in memory.
	 * @param frequentClosed a set of frequent closed itemsets
	 * @return the set of maximal itemsets (if the user chose to keep the result in
	 *         memory.
	 * @throws IOException An exception if an error occurs while writting the output
	 *                     to a file.
	 */
	...
	public void printStats(int transactionCount) {
		...
		System.out.println(" Frequent maximal itemsets count : " + maximalItemsets.getItemsetsCount());
