...
/**
 * This is an implementation of the "MFFI-MINER Algorithm" for Fuzzy Frequent
 * Mining as described in the conference paper : <br/>
 * <br/>
 * 
 * CW Lin��T Li��P Fournier-Viger��TP Hong (2015). Efficient Mining
 * of Multiple Fuzzy Frequent Itemsets. IJFS, 2016:1-9
 *
 * @see MFFIList
 * @see Element
 * @author Ting Li
