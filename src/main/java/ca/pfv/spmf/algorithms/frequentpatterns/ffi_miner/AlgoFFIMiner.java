...
/**
 * This is an implementation of the "MFFI-MINER Algorithm" for multiple Fuzzy
 * Frequent Mining as described in the conference paper : <br/>
 * <br/>
 * 
 * CW Lin��T Li��P Fournier-Viger��TP Hong (2015). A fast Algorithm
 * for mining fuzzy frequent itemsets. JIFS, 2015, 29(6):2373-2379
 *
 * @see FFIList
 * @see Element
 * @author Ting Li
		...
		try {
			...
			while ((thisLine = myInput.readLine()) != null) {
				...
				for (int i = revisedTransaction.size() - 1; i >= 0; i--) {
					...
					// Add a new Element to the fuzzy list of this item corresponding to this
					// transaction
