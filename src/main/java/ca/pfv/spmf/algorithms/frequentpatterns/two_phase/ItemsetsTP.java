...
/**
 * This class represents a set of high utility itemsets found by the Two-Phase
 * algorithm. They are ordered by size. For example, "level 1" means the
 * itemsets of size 1 (containing 1 item).
 * 
 * @see ItemsetTP
 * @see AlgoTwoPhase
