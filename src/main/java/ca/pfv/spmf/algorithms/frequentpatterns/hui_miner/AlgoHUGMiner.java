...
/**
 * This is an implementation of the "HUG-Miner" algorithm for High-Utility
 * Generator Mining as described in the conference paper : <br/>
 * <br/>
 * 
 * "Novel Concise Representations of High Utility Itemsets using Generator
 * Patterns"
 * 
...
public class AlgoHUGMiner {
	 ...
	 * Key: for an item x, Value: a map of item where key is an item y and value is
	 * the TWU of {x,y}
	 */
	...
	public void runAlgorithm(String input, String output, int minUtility) throws IOException {
		...
		// Initialize a map to store the utility list and critical objects of single
		// items
	...
	/**
	 * This is the recursive method to find all HUGs. It writes the HUGs to the
	 * output file.
	 * 
			...
			if (pX_UL.sumIutils + pX_UL.sumRutils >= minUtility) {
				...
				for (int j = i + 1; j < extensionsULs.size(); j++) {
					...
					UtilityListWithCriticalObjects pXYUL = (p_UL.item == null) ? construct(pX_UL, pY_UL, minUtility)
							: construct(p_UL, pX_UL, pY_UL, minUtility);
	...
	/**
	 * This method checks if an itemset pX is a generator (optimized for the case of
	...
	/**
	 * This method constructs the utility list of pXY using the utility lists of p,
	 * pX and pY (done as in HUI-Miner).
	 * 
	 ...
	 */
	private UtilityListWithCriticalObjects construct(UtilityListWithCriticalObjects P,
			UtilityListWithCriticalObjects px, UtilityListWithCriticalObjects py, int minUtility) {
	 ...
	 */
	private UtilityListWithCriticalObjects construct(UtilityListWithCriticalObjects x_UL,
			UtilityListWithCriticalObjects y_UL, int minUtility) {
	...
	public void printStats() throws IOException {
		...
		System.out.println("   Candidate count : " + candidateCount + "     (avoided by EUCP strategy : "
