 ...
 * <br/>
 * 
 * Modifying Apriori to mine closed itemsets was proposed in: <br/>
 * <br/>
 * 
 * Pasquier, N., Bastide, Y., Taouil, R., & Lakhal, L. (1999). Discovering
 * frequent closed itemsets for association rules. In Database
 * Theory�ICDT�99 (pp. 398-416). Springer Berlin Heidelberg.<br/>
 * <br/>
 * 
 * This implementation can save the result to a file or keep it into memory if
 * no output path is provided to the runAlgorithm() method.
 * 
 * @see Itemset
 * @see Itemsets
...
public class AlgoAprioriTIDClose {
	 ...
	 * @param outputFile an output file path, if the result should be saved
	 *                   otherwise leave it null and this method will keep the
	 *                   result into memory and return it.
	 * @return the set of itemsets found if the user chose to save the result to
	 *         memory
