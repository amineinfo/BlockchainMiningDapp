 ...
 * itemsets from a stream as proposed by S.J Yen et al.(2009) in the proceedings
 * of the IEA-AIE 2009 conference, pp.773. <br/>
 * <br/>
 * 
 * It is a very simple algorithm that do not use a minimum support threshold. It
 * thus finds all closed itemsets.
 *
 * @see Itemset
...
public class AlgoCloSteam {
	...
	/**
	 * This method process a new transaction from a stream to update the set of
	 * closed itemsets.
	 * 
