...
/**
 * This is a version of the dECLAT algorithm. It uses sets of integers to
 * represent tidsets. It extends the class AlgoDEclat to avoid redundancy of
 * common code. Note than unlike Eclat, dEclat returns itemsets annotated with
 * diffsets instead of tidsets. About implementation details, note that this
 * implementation uses tidsets initially for single items, then it uses diffsets
 * starting from itemsets containing two itemsets (2-itemsets).
 * 
 * See this article for details about dECLAT: <br/>
 * <br/>
 * 
 * Zaki, M.J., Gouda, K.: Fast vertical mining using diffsets. Technical Report
 * 01-1, Computer Science Dept., Rensselaer Polytechnic Institute (March 2001)
 * 10 <br/>
 * <br/>
 * 
...
public class AlgoDEclat extends AlgoEclat {
	 ...
	 * Tidsets are used for single items and when we make 2-itemsets, we switch to
	 * diffsets.
	 * 
	...
	/**
	 * This method performs the calculation of a new diffset by merging two
	 * tidsets/diffsets.
	 * 
	 * @param tidsetI  the first tidset/diffset
	 * @param supportI the cardinality of the first tidset/diffset
	...
	/**
	 * Calculate the support of an itemset X using the tidset of X if the size = 1.
	 * Otherwise uses diffsets to calculate the support
	 * 
