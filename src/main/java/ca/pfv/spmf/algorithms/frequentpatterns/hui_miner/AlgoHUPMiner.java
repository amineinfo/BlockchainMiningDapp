...
/**
 * This is an implementation of the "HUP-MINER Algorithm" for High-Utility
 * Itemsets Mining as described in the journal paper : <br/>
 * <br/>
 * 
 * Krishnamoorthy, S. (2014). Pruning Strategies for Mining High-Utility
 * Itemsets. Expert Systems with Applications.
 * 
 * This algorithm is a variation of the HUI-Miner algorithm where the database
 * is partitionned. It introduces and additional parameter, which is the number
 * of partitions.
 *
 * @see UtilityListHUP
 * @see Element
...
public class AlgoHUPMiner {
	 ...
	 * @throws IOException
	 */
	private void hupMiner(int[] prefix, int prefixLength, UtilityListHUP pUL, List<UtilityListHUP> ULs, int minUtility)
			throws IOException {
	...
	// === BEGIN HUP-Miner
	/**
	 * This method check if the combination pXY of two itemsets pX and pY and
	 * extensions of pXY should be pruned according to the PU-Prune property.
	 * 
	...
	public void printStats() {
		...
		System.out.println(" Transaction count: " + transactionCount + " Partition count: " + k);
