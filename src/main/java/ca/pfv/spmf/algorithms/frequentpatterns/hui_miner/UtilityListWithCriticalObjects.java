...
class UtilityListWithCriticalObjects extends UtilityList {
	/**
	 * This bit vectors stores the list of transaction containing the itemset
	 * represented by this utility-list
	 */
	BitSet tidset = new BitSet();

	/**
	 * This array of bitsets represents the critical objects of the itemsets
	 * represented by this utility-list (see the DefMe paper for more details about
	 * critical objects
	 */
	BitSet crit[] = null;
