 ...
 *
 * NOTE: This version is modified to add the "minsup" support. Thus this version
 * can discover frequent high-utility itemsets.
 *
 * @see UtilityList
 * @see Element
...
//					int remain = remainingUtility; // FOR OPTIMIZATION
	 ...
	 * @throws IOException
	 */
	private void fhm(int[] prefix, int prefixLength, UtilityList pUL, List<UtilityList> ULs, int minUtility)
			throws IOException {
