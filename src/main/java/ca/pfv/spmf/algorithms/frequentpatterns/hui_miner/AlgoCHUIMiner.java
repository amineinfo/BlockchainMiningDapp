 ...
 * 
 * Wu, C.W., Fournier-Viger, P., Gu, J.-Y., Tseng, V.S. (2015). Mining Closed+
 * High Utility Itemsets without Candidate Generation. Proc. 2015 Conference on
 * Technologies and Applications of Artificial Intelligence (TAAI 2015)
 * 
 * Note that this implementation is an alternative implementation (not the one
 * used in the paper). It has the following differences: - this implementation
 * does not compute the utility unit arrays for recovery of all itemsets. - this
 * implementation adds the EUCP strategy from the FHM algorithm to improve the
 * performance of CHUI-Miner.
 * 
 * @see UtilityList
 * @see Element
...
public class AlgoCHUIMiner {
	 ...
	 * @param output     the output file path or null if the user want to keep
	 *                   result in memory
