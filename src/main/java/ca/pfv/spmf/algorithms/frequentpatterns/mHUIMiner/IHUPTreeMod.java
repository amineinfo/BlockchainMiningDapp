...
/**
 * This is an implementation of the IHUP-Tree used by mHUIMiner. The tree is
 * ordered based on TWU in descending order
 * 
 * @see AlgoMHUIMiner
...
public class IHUPTreeMod {
	...
	/**
	 * Method for creating the header table for IHUP tree, in descending order of
	 * TWU.
	 * 
