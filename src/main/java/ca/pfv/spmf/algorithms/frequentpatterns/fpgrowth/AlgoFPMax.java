 ...
 * <br/>
 * 
 * High Performance Mining of Maximal Frequent Itemsets (with J. Zhu). 6th
 * International Workshop on High Performance Data Mining (HPDM '03) * <br/>
 * <br/>
 * 
...
//		System.out.println(tree);
	 ...
	 */
	private void fpMax(FPTree tree, int[] prefix, int prefixLength, int prefixSupport, Map<Integer, Integer> mapSupport)
			throws IOException {
//		======= DEBUG ========
		if (DEBUG) {
