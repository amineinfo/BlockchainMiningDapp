...
/**
 * This is an implementation of the LCM algorithm for mining frequent closed
...
public class AlgoLCM {
	 ...
	 */
	private void backtrackingLCM(List<Integer> p, List<Transaction> transactionsOfP, List<Integer> frequentItems,
	 ...
	 * @param e
	 */
	private void anyTimeDatabaseReductionClosed(List<Transaction> transactionsPe, int j, List<Integer> frequentItems,
	...
	/**
	 * Check if a given itemset PUe is a PPC extension according to the set of
