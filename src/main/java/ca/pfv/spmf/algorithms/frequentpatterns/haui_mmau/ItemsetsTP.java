...
/**
 * This class represents a set of high average utility itemsets found by the
 * HAUI-MMAU algorithm. They are ordered by size. For example, "level 1" means
 * the itemsets of size 1 (containing 1 item).
 * 
 * @see ItemsetTP
 * @see AlgoHAUIMMAU
 * @author Ting Li, 2016
