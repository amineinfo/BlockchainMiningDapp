 ...
 * <br/>
 * 
 * Fournier-Viger, P. (2014). FHN: Efficient Mining of High-Utility Itemsets
 * with Negative Unit Profits. Proc. 10th International Conference on Advanced
 * Data Mining and Applications (ADMA 2014), Springer LNCS 8933, pp. 16-29.
 * 
 * @see UtilityListFHN
 * @see ElementFHN
...
public class AlgoFHN {
	 ...
	 * @throws IOException
	 */
	private void fhn(int[] prefix, int prefixLength, UtilityListFHN pUL, List<UtilityListFHN> ULs, int minUtility)
			throws IOException {
