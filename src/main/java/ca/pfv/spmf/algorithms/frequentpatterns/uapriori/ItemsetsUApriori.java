...
/**
 * This class represents a set of itemsets found in an uncertain database, as
 * used by the UApriori algorithm uncertain itemset mining. They are ordered by
 * size. For example, level 1 means itemsets of size 1 (that contains 1 item).
 *
 * @see AlgoUApriori
 * @see ItemUApriori
 * @see ItemsetUApriori
...
public class ItemsetsUApriori {
	...
	private final List<List<ItemsetUApriori>> levels = new ArrayList<List<ItemsetUApriori>>(); // itemset classé par
																								// taille
	...
	/**
	 * Get the itemsets stored in this structure as a List of List where position i
