...
/**
 * This class represents the TC table of candidates , used by the Zart
 * algorithm.
 * 
 * @see AlgoZart
...
public class TCTableCandidate {
	...
	/**
	 * This structure stores the candidate itemsets by size Position i contains the
	 * list of candidate itemsets of size i
	 */
