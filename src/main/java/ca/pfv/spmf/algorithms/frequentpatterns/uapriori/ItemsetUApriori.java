...
/**
 * This class represents an itemset (a set of items) as used by the UApriori
 * algorithm uncertain itemset mining.
 *
 * @see AlgoUApriori
 * @see ItemUApriori
...
public class ItemsetUApriori {
	 ...
	 * except the last item and that itemset2 is lexically smaller than this
