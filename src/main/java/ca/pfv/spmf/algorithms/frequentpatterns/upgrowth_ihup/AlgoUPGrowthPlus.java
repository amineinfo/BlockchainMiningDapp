 ...
 *
 * V. S. Tseng, B.-E. Shie, C.-W. Wu, and P. S. Yu. Efficient algorithms for
 * mining high utility itemsets from transactional databases. IEEE Transactions
 * on Knowledge and Data Engineering, 2012, doi: 10.1109/TKDE.2012.59.<\br><\br>
 *
...
public class AlgoUPGrowthPlus {
	 ...
	 * @return -1 if item1 is smaller than 2. 1 if item 1 is greater than 2.
	 *         Otherwise 0.
	 */
