...
/**
 * This class runs the CHUD algorithm. It wraps the code for converting an
 * horizontal database to a vertical database and the code for performing Phase
 * 1 and Phase 2 of the CHUD algorithm. <br/>
 * <br/>
 * 
...
public class AlgoCHUD {
	...
	/**
	 * Debug mode : if true some details will be shown in the console when running
	 * CHUD
	 **/
	...
	public void runAlgorithm(String dataset, String output, int minUtility) throws IOException {
		...
		if (file.exists() == false) {
			...
			if (DEBUG) {
				...
				System.out.println(
						"Time conversion: " + converter.totaltime / 1000 + "s   (" + converter.totaltime + " ms)");
			}
		}
