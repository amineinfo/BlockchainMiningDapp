 ...
 * 
 * The code of TKU was obtained from the UP-Miner project, which is distributed
 * under the GPL license and slightly modified by Philippe Fournier-Viger to
 * integrate TKU into SPMF.
 * 
 * @see AlgoTKU
 */
