...
public class MISNode {
	...
	/**
	 * Return the immmediate child of this node having a given ID. If there is no
	...
	/**
	 * Return the index of the immmediate child of this node having a given ID. If
	 * there is no such child, return -1;
	 */
