 ...
 * <br/>
 * 
 * Fournier-Viger, P., Lin, C. W., Dinh, T., Le, H. B. (2016). Mining Correlated
 * High-Utility Itemsets Using the Bond Measure. Proc. 11 th International
 * Conference on Hybrid Artificial Intelligence Systems (HAIS 2016), Springer
 * LNAI, 14 pages, to appear.
 * 
 * @see UtilityListFCHM
 * @see Element
...
//						}
	 ...
	 * @throws IOException
	 */
	private void fchm(int[] prefix, int prefixLength, UtilityListFCHM pUL, List<UtilityListFCHM> ULs, int minUtility)
			throws IOException {
