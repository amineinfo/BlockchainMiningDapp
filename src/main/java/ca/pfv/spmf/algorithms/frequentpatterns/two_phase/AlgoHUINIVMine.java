...
/**
 * This is an implementation of the "HUINIV-Mine" for High-Utility Itemsets
 * Mining while considering negative profit value. HUINIV-Mine is described in
 * this paper: <br/>
 * <br/>
 * 
 * Chu, Chun-Jung, Vincent S. Tseng, and Tyne Liang. "An efficient algorithm for
 * mining high utility itemsets with negative item values in large databases."
 * Applied Mathematics and Computation 215.2 (2009): 767-778.<br/>
 * <br/>
 *
 * @see ItemsetsTP
 * @see ItemsetTP
