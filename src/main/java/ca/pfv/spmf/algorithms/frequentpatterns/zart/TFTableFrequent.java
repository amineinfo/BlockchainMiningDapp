...
/**
 * This class represents the TF table of frequent itemsets, used by the Zart
 * algorithm.
 * 
 * @see AlgoZart
...
public class TFTableFrequent {
	...
	/**
	 * This store the frequent itemsets by size At position i, there are the list of
	 * frequent itemsets of size i
	 */
	public final List<List<Itemset>> levels = new ArrayList<List<Itemset>>(); // itemset class� par taille

	/**
	 * This map is the mapPredSupp used by Zart to store the support of a frequent
	 * itemset <br/>
