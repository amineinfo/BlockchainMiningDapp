...
/**
 * This class converts an horizontal database to a vertical database for
 * applying the CHUD algorithm, which was proposed in <br/>
 * <br/>
 * 
...
class AlgoConvertToVerticalDatabase {
	 ...
	 * @throws IOException exception if an error occur while reading/writing the
	 *                     output files.
	 */
	...
	/**
	 * This is an inner class that is used for converting the database It represents
	 * an item, the list of identifiers (tids) of transactions containing that item,
	 * and the utility of this item in each of these transactions.
	 */
