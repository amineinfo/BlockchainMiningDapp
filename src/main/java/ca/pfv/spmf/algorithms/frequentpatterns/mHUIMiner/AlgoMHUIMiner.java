...
/**
 * This is an implementation of the mHUIMiner algorithm. The algorithm takes
 * transaction data in SPMF format and a user specified minUtility, and outputs
 * all the high utility itemsets. <\br><\br>
 * 
 ...
 * 
 * This is the original implementation obtained from the GitHub repository. It
 * has been slightly adapted for integration in the SPMF software.
 * 
 * 
 * @see IHUPTreeMod
 * @see UtilityTuple
