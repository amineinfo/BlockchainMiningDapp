...
/**
 * This is an implementation of the AprioriClose (a.k.a Close) algorithm as
 * described by : <br/>
 * <br/>
 * 
 ...
 * <br/>
 * 
 * The AprioriClose algorithm is an extension of the Apriori algorithm proposed
 * in: <br/>
 * <br/>
 * 
 ...
 * or keep it into memory if no output path is provided by the user to the
 * runAlgorithm() method.
 * 
...
//				saveItemsetToFile(entry.getKey(), entry.getValue());
	 ...
	 * @throws IOException exception if error writing output file
	 */
	private void checkIfItemsetsK_1AreClosed(List<Integer> levelKm1, List<Itemset> levelK,
			Map<Integer, Integer> mapItemCount) throws IOException {
		// for each itemset of size k-1
