 ...
 * 
 * Source: J. Pitkow and P. Pirolli, "Mining longest repeating subsequences to
 * predict world wide web surfing" in Proc. USENIX Symp. on Internet
 * Technologies and Systems, 1999, pp. 1.
 */
public class MarkovAllKPredictor extends Predictor {
	...
	/**
	 * contains a list of unique items (one or multiple) and their state in the
	 * Markov model
	 */
