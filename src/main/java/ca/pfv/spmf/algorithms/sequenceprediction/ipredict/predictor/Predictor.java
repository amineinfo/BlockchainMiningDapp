...
public abstract class Predictor {
	...
	/**
	 * Represent the unique name of this predictor each subclass should overwrite
	 * this TAG
	 */
	...
	/**
	 * Get the size of the predictor after training where the unit is an arbitrary
	 * value such as number of nodes (for graph and trees)
	 */
	public abstract long size();

	/**
	 * Get the size in bytes of the predictor after training, the size should be
	 * theoretical and not obtained from Java directly.
	 */
