 ...
 */
/**
 * PHIL08 This class encapsulate the BitSet class and make sure that when we
 * call cardinality, it is not calculated more than once.
 * 
 * There are two cases: - When we do a AND operation, the cardinality is
 * recalculated. - When we set a it during the "preload" phase, we do
 * cardinality ++;.
 */
