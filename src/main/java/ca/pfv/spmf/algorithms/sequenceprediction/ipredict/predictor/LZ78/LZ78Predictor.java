 ...
 * 
 * K. Gopalratnam and D. J. Cook. Active Lezi: An incremental parsing algorithm
 * for sequential prediction. In Proceedings of the Florida Artiï¬�cial
...
public class LZ78Predictor extends Predictor {
	...
	public Boolean Train(List<Sequence> trainingSequences) {
		...
		// TODO: [Reduce spatial size] Implement the mDictionary with a String hash
		// instead of a List<Integer>, see AllKOrderMarkov.
	...
	public Sequence Predict(Sequence target) {
		...
		for (Item item : lastItems) {
			...
			/**
			 * START OF BUG FIX 2018-01-25 Fixed LZ78 Prediction Bug. It is possible that a
			 * phrase <a, b> is in the dictionary, while the shorter phrase <b> is not. This
			 * is the case when the sequence <a, a, b, a, b, c> is learned and a prediction
			 * for <a, b, ?> is requested. Breaking the prediction because of the missing
			 * dictionary entry <b>, would result in no prediction, although there is an
			 * entry in the dictionary that recommends c as a successor of <a, b>.
			 */
...
//			}
	...
	/**
	 * There is 3 integer per node (12 bytes) + a list of pointers to the other
	 * nodes
	 */
