 ...
 *
 * Source: V. N. Padmanabhan and J. C. Mogul, "Using predictive prefetching to
 * improve world wide web latency" ACM SIGCOMM Computer Communication Review,
 * vol. 26, pp. 22-36, 1996.
 */
public class DGPredictor extends Predictor {
	...
	public Boolean Train(List<Sequence> trainingSequences) {
		// TODO: Resolve ABB...AC...AD...ABB problem, described in Mogul&Padmanabhan (3.
		// some Issues)
