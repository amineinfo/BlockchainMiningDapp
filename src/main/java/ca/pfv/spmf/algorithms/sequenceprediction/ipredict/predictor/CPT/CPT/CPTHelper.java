...
public class CPTHelper {
	...
	/**
	 * Slice a sequence into subsequence of size of Length Caution: this can
	 * generate a lot of subsequences
	 * 
	 * @param sequence the sequence to slice
	 * @param length   the size of the subsequences
	 */
	public static List<Sequence> slice(Sequence sequence, int length) {
		...
		// Checking if the last item has been taken already, if not then we generate a
		// sequence for him
