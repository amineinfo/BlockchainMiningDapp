 ...
 * 
 * 
 * Source: J. G. Cleary and I. Witten, "Data compression using adaptive coding
 * and partial string matching" Communications, IEEE Transactions on, vol. 32,
 * pp. 396-402, 1984. Source: J. Pitkow and P. Pirolli, "Mining longest
 * repeating subsequences to predict world wide web surfing" in Proc. USENIX
 * Symp. on Internet Technologies and Systems, 1999, pp. 1.
 */
public class MarkovFirstOrderPredictor extends Predictor {
	...
	/**
	 * Each node on the first level is an int (4 bytes) For each of these nodes,
	 * each child is two ints (8 bytes), one for the value/id and the other for its
	 * support
	 */
